(function() {
  ...
  // === Progress ===
  var LESSON_SLUGS = [
    'james-1', 'james-2', 'james-3', 'james-4', 'james-5', 'james-6',
    'ephesians-1', 'ephesians-2', 'ephesians-3', 'ephesians-4', 'ephesians-5', 'ephesians-6'
  ];
  var LESSON_TITLES = {
    'james-1': 'Иакова: Урок 1. Вера и дела',
    'james-2': 'Иакова: Урок 2. Вера и духовный рост',
    'james-3': 'Иакова: Урок 3. Вера и общество',
    'james-4': 'Иакова: Урок 4. Вера и наши слова',
    'james-5': 'Иакова: Урок 5. Вера и борьба',
    'james-6': 'Иакова: Урок 6. Вера и практика',
    'ephesians-1': 'Ефесянам: Урок 1. Введение',
    'ephesians-2': 'Ефесянам: Урок 2. Величие и план Бога',
    'ephesians-3': 'Ефесянам: Урок 3. Возрождение и примирение',
    'ephesians-4': 'Ефесянам: Урок 4. Тайна Благой вести',
    'ephesians-5': 'Ефесянам: Урок 5. Жизнь во свете',
    'ephesians-6': 'Ефесянам: Урок 6. Взаимоотношения и всеоружие'
  };
